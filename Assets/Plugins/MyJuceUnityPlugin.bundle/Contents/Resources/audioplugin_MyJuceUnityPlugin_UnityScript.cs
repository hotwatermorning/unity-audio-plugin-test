...
public class MyJuceUnityPluginGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "MyJuceUnityPlugin"; } }
    public override string Description    { get { return "MyJuceUnityPlugin"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("MyJuceUnityPlugin")] static extern System.IntPtr getRenderCallback();

    [DllImport("MyJuceUnityPlugin")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("MyJuceUnityPlugin")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("MyJuceUnityPlugin")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("MyJuceUnityPlugin")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("MyJuceUnityPlugin")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("MyJuceUnityPlugin")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
